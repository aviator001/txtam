...
webrtc.on('videoAdded', function (video, peer) {
	...
	if (remotes) {
		...
		if (localVideo.height > localVideo.width) {
			localVideo.transform='scaleX(localVideo.height/localVideo.width)'
		} else {
			localVideo.transform='scaleX(localVideo.height/localVideo.width)'
		}
		remotes.style.width='100%'
		container.style.width='100%'
		localVideo.border='10px solid white'
		localVideo.borderRadius='100px'
		localVideo.width='200px'
		localVideo.height='200px'
		video.style.width='100%'
		video.style.position='absolute'
		video.style.zIndex='99'
		localVideo.position='absolute'
		localVideo.zIndex='9999999999999999999'
