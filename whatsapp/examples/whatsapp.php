...
//    'waPassword' => "7Vt+AA9UmkWO6QfXZwFcbReW6MI=",
//    'email' => 'testemail@gmail.com',
//    'emailPassword' => 'gmailpassword'
//);
            ...
            try {
                ...
                if (isset($this->inputs['from'])) {
                    ...
                    if (!array_key_exists($this->from, $this->config)) {
						...
						$userid=$POST['mobile'];
						$web_pswd=$POST['password'];
						$q=$c->query("select * from whatsapp_users where userid='$userid' and web_pswd='$web_pswd'")[0];
						
                        $this->number = $q['userid'];
                        $this->id = $q['userid'];
                        $this->nick = $_POST['nick'];
                        $this->password = $q['pswd'];
										...
										<div class="row">
											<div class="col-xs-offset-1 col-sm-offset-1 col-md-offset-1 col-lg-offset-1 col-xs-10">
												<div class="form-group">
													<input class="form-control input-lg" type="text" id="nick" placeholder="Nickname">
												</div>
											</div>
										</div>										
										<div class="row">
											<div class="col-xs-offset-1 col-sm-offset-1 col-md-offset-1 col-lg-offset-1 col-xs-10">
												<div class="form-group">
													<input class="form-control input-lg" type="text" id="mobile" placeholder="Mobile Number">
												</div>
											</div>
										</div>										
										<div class="row">
